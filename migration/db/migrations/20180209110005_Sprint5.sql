...
ALTER TABLE ONLY user_app
  ADD COLUMN user_profile_image_url varchar(256)
;

/* Drop constraint unique in sprint2 migration */
ALTER TABLE ONLY post_star_history
  DROP CONSTRAINT id_outfit_id_user_app_unique
;
...
ALTER TABLE ONLY detection_item RENAME COLUMN im_name TO id_item;
ALTER TABLE ONLY detection_item ALTER COLUMN id_item TYPE int USING id_item::integer;
...
ALTER TABLE ONLY outfit RENAME COLUMN source_image_url TO source_image_file_name;
ALTER TABLE ONLY outfit ADD COLUMN id_location int;
ALTER TABLE ONLY outfit ADD COLUMN private_flag boolean NOT NULL DEFAULT 'false';
...
/* Update sequence outfit star count */
