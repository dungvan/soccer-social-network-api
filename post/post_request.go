...
type CreateRequest struct {
	...
	SourceImageFileName []string   `json:"source_image_file_name" validate:"omitempty,dive,gt=0,source_im_name"`
	SourceVideoFileName []string   `json:"source_video_file_name" validate:"omitempty,dive,gt=0,source_video_name"`
