...
func (h *BaseHTTPHandler) Validate(w http.ResponseWriter, req interface{}) error {
...
// https://github.com/go-playground/form
func (h *BaseHTTPHandler) ParseJSON(r *http.Request, i interface{}) ([]string, error) {
	// mapping post to struct.
...
func (h *BaseHTTPHandler) DetectImageDimention(imageFile multipart.File) (width, height int, error error) {
